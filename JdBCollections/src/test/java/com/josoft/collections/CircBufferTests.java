...
public final class CircBufferTests {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Oldest element buffer 1: ");
        System.out.print(cBuff1.getFromOldest(0).toString());
        System.out.print("\r\n");

        System.out.print("Newest element buffer 1: ");
        System.out.print(cBuff1.getFromNewest(0).toString());
        System.out.print("\r\n");
        ...
        boolean contentOK = cBuff1.getFromOldest(0) == 7;
        for (int i = 7; i < 16; i++) {
            if (cBuff1.getFromOldest(i - 7) != i) {
                contentOK = false;
            }
